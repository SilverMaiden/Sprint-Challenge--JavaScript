...
graduates.forEach(function(element) {
    let str = element.first_name + ' ' + element.email;
...
each string following this pattern:
...
let populationArray = [];
zooAnimals.forEach(element => populationArray.push(element.population));

const populationTotal = populationArray.reduce((first, second) => first + second);
